...
class BaiduCrawler(BaseCrawler):
    ...
    def __init__(self, search_key='', **kwargs):
        ...
        self.search_url_prefix = kwargs.get('search_url_prefix', 'https://image.baidu.com/search/index?tn=baiduimage&ie=utf-8&word=')
        self.search_url_postfix = kwargs.get('search_url_postfix', '')

        # show more options
        # options : 'id','class'
        self.show_more_find_type = kwargs.get('show_more_find_type', 'id')
        self.show_more_find_value = kwargs.get('show_more_find_value', 'pageMore')

        # image options
        self.preview_image_class = kwargs.get('preview_image_class', 'main_img')
        self.original_image_class = kwargs.get('original_image_class', 'imgitem')
